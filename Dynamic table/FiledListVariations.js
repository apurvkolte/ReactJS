...
export var productTableVariation = "";

const FiledListVariations = (props) => {
    productTableVariation = props.productVariation;

    return props.productVariation.map((val, idx) => {
...
export default FiledListVariations;
