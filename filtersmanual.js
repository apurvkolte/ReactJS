...
const Products = ({ products1, productFilters, fetchProduct }) => {
    ...
    const receiveDataFromCategory = (data) => {
    ...
    //             <li key={i} onClick={(e) => receiveDataFromCategory(`${item.category}`)}>
                        ...
                        <div className="row">
                            <div className="col-lg-3 primary-sidebar sticky-sidebar">
                                <div className="widget-category mb-30">
                                    ...
                                    <CategoryProduct receiveDataFromCategory={receiveDataFromCategory} />
                                </div>
                                ...
                                <div className="sidebar-widget price_range range mb-30">
                                    ...
                                    <div className="price-filter">
                                        <div className="price-filter-inner">
                                            <br />
                                            <PriceRangeSlider filterPrice={filterPrice} />
                                            <br />
                                        </div>
                                    </div>
                                ...
                                <div className="shop-product-fillter">
                                    ...
                                    <div className="sort-by-product-area">
                                        ...
                                        <div className="sort-by-cover">
                                            <SortSelect sortfilter={sortfilter} />
                                        </div>
                                    </div>
                                </div>
                                <div className="row product-grid-3">
                                    {/* {productImages && products.map((product, i) => (
                                        <div
