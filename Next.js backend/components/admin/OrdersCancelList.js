...
const OrdersCancelList = () => {
    ...
    const { loading, error, cancelOrders } = useSelector(state => state.allOrders);
            ...
            <div className="row">
                ...
                <div className="col-12 col-md-10">
                    <Fragment>
                        ...
                        <h3 style={{ display: 'inline' }} className="mt-5 ml-2 px-md-2"><Link href={'/admin/orders/cancel'} className='menuorder'>Cancel Orders</Link></h3>
                        <h3 style={{ display: 'inline' }} className="mt-5 ml-2 px-md-2"><Link href={'/admin/orders/return'} className='menuorder1 heading'>Return Orders</Link></h3>
