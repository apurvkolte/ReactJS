...
const index = () => {
    ...
    useEffect(() => {
        ...
        if (router.query) {
            setProductName(router.query?.name)
        }
        if (router.query) {
            setProductQuantity(router.query?.quantity)
        }

    }, [dispatch, success, session, error])
    ...
    function submit(data, e) {
        ...
        formData.set("pName", productName);
    ...
    return (
        <div className='container d-flex justify-content-center p-5'>
            ...
            <section className='col-md-7 '>
                <SectionsHead heading="Product Enquiry Form" /><br />
                                ...
                                <form name="myform11" onSubmit={handleSubmit(submit)}>
                                    <div className="row enquiryForm mb-2">
                                        ...
                                        <div className="col-md-7 form-group">
                                            ...
                                            {errors.mobile && (
                                                <small className="text-danger"><br />{errors.mobile.message}</small>
                                            )}
                                        </div>
