...
export const productsReducer = (state = { products: [], productsTop: [], productImages: [], productImagesTop: [], imagesData: [], products1: [], videoImages: [] }, action) => {
    switch (action.type) {
        ...
        case ALL_PRODUCTS_SUCCESS:
            return {
                ...
                videoImages: action.payload.videoImages
            }
...
export const productDetailsReducer = (state = { product: {}, productImages: [], relatedProduct: [], RelatedProductImages: [], productDetails: [], productProperties: [] }, action) => {
    switch (action.type) {
